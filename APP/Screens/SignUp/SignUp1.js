...
const SignUp1 = ({ navigation }) => {
  return (
    ...
    <View style={{ alignItems:'center'}}>
        <Text style={{ fontSize:27, fontWeight:'700', color:"#5AB500", marginTop:0}}>
            Welcome to
        </Text>
    ...
    <View style={{ alignItems:'center', marginTop:40}}>
        <TouchableOpacity style={{ justifyContent:'center', alignItems:'center', backgroundColor:'#5AB500', width:'80%', height:50, borderRadius:48, marginBottom:40}}>
            <Text style={{ color:'#fff', fontSize:24, fontWeight:'700'}}>Login</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>{navigation.navigate('SignUp2')}} style={{ justifyContent:'center', alignItems:'center', backgroundColor:'#D9D9D9', width:'80%', height:50, borderRadius:48}}>
            <Text style={{ color:'#5AB500', fontSize:24, fontWeight:'700'}}>Signup</Text>
        </TouchableOpacity>
    </View>
