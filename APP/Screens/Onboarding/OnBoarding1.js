  ...
  return (
    <SafeAreaView style={{flex:1, backgroundColor:"#F5F5F5"}}>
      ...
      <View style={{ padding:30, alignItems:'center', flex:1}}>
        <Text style={{ fontFamily:'Montserrat-bold', fontSize:25, alignItems:'center', color:'#002C11', textAlign:'center'}}>
          Serving over 5,000 resturants in East Africa
        </Text>
        <TouchableOpacity><Text style={{ textAlign:'center', marginTop:20, fontSize:17, textDecorationLine:'underline', fontFamily:'Montserrat-regular'}}>See Who's onboard</Text></TouchableOpacity>
